...
(function ($) {
  ...
  function Element(htmlElement) {
    ...
    if ($(this.htmlElement).attr("data-animation-duration") !== undefined) {
      //Get the values
      this.animationDuration = $(this.htmlElement)
    ...
    if ($(this.htmlElement).attr("data-animation-delay") !== undefined) {
      //Get the values
      this.animationDelay = $(this.htmlElement)
  ...
  Element.prototype.doNextAnimation = function (callback) {
    ...
    $(this.htmlElement)
      ...
      .css("-ms-animation-duration", "")
      .css("-o-animation-duration", "");
    //If we defined a duration for this animation...
    if (
      this.animationDuration !== undefined &&
      this.animationDuration[this.animationIndex] !== undefined
    ) {
      //... set it
      ...
      $(this.htmlElement)
        ...
        .css("-moz-animation-duration", duration)
        .css("-ms-animation-duration", duration)
        .css("-o-animation-duration", duration);
    }
    ...
    $(this.htmlElement)
      ...
      .css("-ms-animation-delay", "")
      .css("-o-animation-delay", "");
    //If we defined a delay for this animation...
    if (
      this.animationDelay !== undefined &&
      this.animationDelay[this.animationIndex] !== undefined
    ) {
      //... set it
    ...
    if (!this.isReset) {
      ...
      for (var i = 1; i < this.elements.length; i++) {
        for (var j = 0; j < this.elements[i].length; j++) {
          ...
          $(this.elements[i][j].htmlElement).removeClass(
            this.elements[i][j].lastAnimation
          );
        }
      }
  ...
  function AnimatePlus() {
    ...
    $.each(
      ...
      function (key, animatedElement) {
        ...
        var animateWhenVisible = $(animatedElement).attr(
        ...
        var resetWhenOffscreen = $(animatedElement).attr(
        ...
        var animationOrderAttribute = $(animatedElement).attr(
    ...
    this.isElementVisible = function (element) {
      ...
      return (
        bottomWindowLimit >= topElementLimit &&
        topWindowLimit <= bottomElementLimit
      );
    };
        ...
        for (var j = 1; j < groupMap.elements.length; j++) {
          ...
          for (var k = 0; k < elements.length; k++) {
            ...
            if (
              ...
              !groupMap.isPerformingAnimation
            ) {
              //Animate this group
              groupMap.animate(1);
            }
